...
wandb.login(key= os.getenv('WANDB_API_KEYS'))
def get_baseline_run(entity='aagombe7-tagtechnologies', project='chatbot', tag='baseline'):
...
def compare_runs(entity='aagombe7-tagtechnologies',
                 project='chatbot',
                 tag='baseline',
                 run_id=None):
    ...
    run_id = os.getenv('RUN_ID') or nhrhvrd9
